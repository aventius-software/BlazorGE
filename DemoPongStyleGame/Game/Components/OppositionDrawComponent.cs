...
{
    public class OppositionDrawComponent : GameComponentBase, IDrawableGameComponent
    {
        ...
        public OppositionDrawComponent(IGraphicsService2D graphicsService2D)
        {
